...
class VariationController extends GetxController {
  ...
  void onAttributeSelected(
    ...
    // when attribute is selected we will first and that attribute to the selectedAttributes
  ...
  bool _isSameAttributeValues(Map<String, dynamic> variationAttributes,
    ...
    // if selectedAttributes contains 3 attributes and current variation contains2 then return.
