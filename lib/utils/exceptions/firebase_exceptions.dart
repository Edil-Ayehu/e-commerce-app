class TFirebaseException implements Exception {
  ...
  String get message {
    switch (code) {
      ...
      case 'invalid-email':
        return 'The email addresss provided is invalid. Please enter a valid email.';
      ...
      case 'user-token-mismatch':
        return 'The provided user\'s token has a mismathc with the authenticated user\'s user ID.';
      ...
      case 'user-token-expired':
        return 'The user\'s toke has expired, and authentication is required. Please sign in again.';
